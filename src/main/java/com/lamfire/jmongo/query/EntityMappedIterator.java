...
public class EntityMappedIterator<T, V> implements Iterable<V>, Iterator<V>{
	...
	public EntityMappedIterator(Iterator<DBObject> it, Mapper m, Class<T> clazz, String kind, EntityCache cache) {
		this.wrapped = it;
		this.m = m;
		this.clazz = clazz;
		this.kind = kind;
